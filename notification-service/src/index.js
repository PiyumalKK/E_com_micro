...
const { startConsumer } = require('./services/servicebus');
...
const swaggerOptions = {
  definition: {
    ...
    info: {
      ...
      version: '1.0.0',
      description: 'Notification management service for ShopEase'
    },
...
const startServer = async () => {
  try {
    ...
    await connectWithRetry(process.env.MONGODB_URI || 'mongodb://localhost:27017/shopease-notifications');

    // Start Service Bus consumer for order notifications
    await startConsumer();
